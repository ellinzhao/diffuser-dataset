...
This writeup documents the work done on generating datasets for the DiffuserCam project. The dataset consists of volumes with varying densities of florescent point sources. 
